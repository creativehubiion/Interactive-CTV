...
(function () {
  ...
  function onStart() {
    ...
    // PAUSETEST VARIANT — requestPause RE-ADDED (the old pre-fix behaviour)
    // to double-confirm whether the pause call breaks navigation on the
    // Media3 1.8.0 + IMA 3.35.1 stack.
